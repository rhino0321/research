...
test_first_zero_after_nonzero_index = 4500
...
decoded_data, test_predictions = vae_lstm.predict([t_refluctuation_matrix, t_input_data])
vae_lstm_r2 = r2_score(t_target_data, test_predictions)
vae_lstm_rmse = np.sqrt(mean_squared_error(t_target_data, test_predictions))
...
GRU_L1 = GRU(units = 1, activation = 'sigmoid', return_sequences = False)(lstm_input_reshaped)
...
plt.show()
'''
test_GRU_predictions = gru.predict(t_input_data)
GRU_r2 = r2_score(t_target_data, test_GRU_predictions)
GRU_rmse = np.sqrt(mean_squared_error(t_target_data, test_GRU_predictions))
...
plt.show()
'''
test_lstm_predictions = lstm.predict(t_input_data)
LSTM_r2 = r2_score(t_target_data, test_lstm_predictions)
LSTM_rmse = np.sqrt(mean_squared_error(t_target_data, test_lstm_predictions))
